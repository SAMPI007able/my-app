...
const ProjectCreationScreen = ({navigation}) => {
  ...
  return (
    <AdminLayout navigation={navigation}>
      <View style={styles.container}>
        <Text variant="titleMedium" style={styles.title}>Enter the following details about the project</Text>
        <TextInput
          style={styles.input}
        ...
        <TextInput
          ...
          placeholder='Enter brief description about the project'
